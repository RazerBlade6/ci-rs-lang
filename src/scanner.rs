...
use lazy_static::*;
use crate::token::{Token, TokenType as Type, Literal};
...
impl Scanner {
    ...
    fn number(&mut self) {
        ...
        self.add_token(Type::Number, Literal::Numeric(self.src[self.start..self.current].parse::<f64>().unwrap()))
    }
...
mod tests {
    ...
    fn test_scanner() {
        ...
        assert_eq!(
            vec![Token::new(Type::Number, "123", Literal::Numeric(123.0), 1),
